...
<section class="container">
  <div class="main">
    ...
    <Button.Root class="button type--secondary icon--md"
      ><i class="lni lni-plus"></i></Button.Root
    >
    <Button.Root class="button type--secondary icon--md" disabled
      ><i class="lni lni-plus"></i></Button.Root
    >
    <br />
    <Button.Root class="button type--primary icon--sm"
      ><i class="lni lni-cog"></i></Button.Root
    >
    <Button.Root class="button type--primary icon--sm" disabled
      ><i class="lni lni-cog"></i></Button.Root
    >
  </div>
</section>
