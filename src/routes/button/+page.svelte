...
<section class="container">
	...
	<div class="main">
		...
		<br/>
		<Button.Root class="button type--primary icon--sm"><img src="../assets/svg/bulb.svg"></Button.Root>
		<Button.Root class="button type--primary icon--sm" disabled><img src="../assets/svg/bulb.svg"></Button.Root>
